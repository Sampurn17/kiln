  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-white/20">
      ...
      <section className="relative flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        {/* Hexagon backdrop — masked so it fades out, content stays bright */}
        <HexagonBackground
        ...
        <Badge variant="outline" className="relative z-10 gap-2 border-white/15 p-4 backdrop-blur-sm">
          <div className="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-400" />
          Powered by Agentic AI
        </Badge>

        <h1 className="relative z-10 mx-auto mt-6 max-w-3xl text-balance font-serif text-5xl leading-tight tracking-tight sm:text-6xl lg:text-7xl">
          <GrayTitle>Dream come true</GrayTitle>
          <br />
          <BlueTitle>from a single prompt.</BlueTitle>
        </h1>

        <p className="relative z-10 mx-auto mt-6 max-w-xl text-balance text-base leading-relaxed text-white/60">
        ...
        <div className="relative z-10 mx-auto mt-12 w-full max-w-2xl">
          <div
            className={cn(
              "rounded-2xl border bg-[#111111]/90 backdrop-blur-sm shadow-xl shadow-black/40 duration-200",
              isFocused
                ? "border-blue-400/30 ring-2 ring-blue-500/15"
                : "border-white/12"
            )}
          >
            <textarea
              ...
              rows={1}
              className="w-full resize-none bg-transparent px-5 pb-4 pt-5 text-sm text-white placeholder:text-white/35 focus:outline-none sm:text-base"
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-2">
            {SUGGESTIONS.map((s) => (
              <button
                ...
                className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/50 transition-all hover:border-blue-400/25 hover:bg-white/10 hover:text-white/80"
              >
                {s}
              </button>
            ))}
      ...
      {/* ── CTA ───────────────────────────────────────────────────────────── */}
      <section className="px-4 pb-32">
        <div className="relative mx-auto flex max-w-5xl flex-col items-center overflow-hidden rounded-2xl border border-white/8 bg-[#0f0f0f] px-10 py-24 text-center">
          {/* Decorative gradient */}
          <div
            className="pointer-events-none absolute inset-0"
            style={{
              background:
                "radial-gradient(ellipse at 50% 100%, rgba(59,130,246,0.1) 0%, transparent 55%), radial-gradient(ellipse at 50% 0%, rgba(59,130,246,0.05) 0%, transparent 50%)",
            }}
          />

          <SectionHeading gray="Start building," blue="for free." />

          <p className="relative mt-4 mb-8 max-w-md text-sm leading-relaxed text-white/50">
          ...
          <SignInButton mode="modal">
            <Button
              size="lg"
              className="relative h-11 rounded-full bg-white px-8 text-black font-semibold hover:bg-white/90 active:scale-95 transition-all"
            >
              Get started free
      ...
      <footer className="border-t border-white/7 py-12 mx-auto px-6 flex flex-wrap items-center justify-center text-stone-400">
